...
import com.bishe2.bishe2.http.response.teacher.TeacherResponse;
...
public class TeacherController {
    ...
    @ResponseBody
    public TeacherResponse list(@RequestParam Integer limit, @RequestParam Integer page) {
        ...
        int a = limit*(page-1);
        int b = limit*page;
        List<Teacher> teacherList = findUserService.TeacherList(a,b);
